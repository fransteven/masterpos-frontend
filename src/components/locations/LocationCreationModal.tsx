...
export default function LocationCreationModal() {
    ...
    const queryParam = queryParams.get('createLocation');
                                ...
                                <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                    <div className='relative'>
                                        ...
                                        <Dialog.Description className="mt-1 text-sm text-gray-500 mb-4">
                                            Completa los siguientes campos para crear una nueva locación.
                                        </Dialog.Description>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            ...
                                            <div className="md:col-span-2">
                                                ...
                                                <input
                                                    ...
                                                    {...register('name', { required: 'El nombre de la locación es obligatorio' })}
                                                />
                                                {
                                                    errors.name&&(
